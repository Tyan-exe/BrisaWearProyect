    ...
    <div className="d-flex vh-100 align-items-center justify-content-center bg-light p-4">
      <div className="card shadow" style={{ maxWidth: "400px", width: "100%" }}>
        <div className="card-body d-flex flex-column align-items-center">
          <h1 className="text-center fw-bold mb-4">Registro</h1>
          ...
          <form className="w-100" onSubmit={handleSubmit}>
            <div className="form-group py-2">
              <label className="py-2 px-1" htmlFor="displayName">Nombre completo</label>
              <input
                type="text"
            ...
            <div className="form-group py-2">
              <label className="py-2 px-1" htmlFor="confirmPassword">Confirmar contraseña</label>
              <input
                type="password"
                className="form-control"
                id="confirmPassword"
